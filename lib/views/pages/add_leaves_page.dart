                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const DropdownInput<String>(
                        ...
                        topLabel: 'Permission Type',
                        label: 'Select a permission type',
                      ),
                          ...
                          if (form.valid) {
                            ...
                            try {
                              ...
                              Fluttertoast.showToast(
                                  msg: 'Successfully applied for permission');
            ...
            children: [
              ...
              Center(
                child: Column(
                  ...
                  children: [
                    Text(
                      DateFormat('EEE', 'en-SA').format(DateTime.parse(date)),
                      style: whiteTextStyle.copyWith(
                          fontSize: 16, fontWeight: FontWeight.bold),
                    ),
                    const SizedBox(height: 3),
                    Text(
                      DateFormat('d MMM y', 'en-SA').format(DateTime.parse(date)),
      ...
      child: InkWell(
        onTap: () async {
          ...
          if (pickedDate != null) {
            ...
            if (check) {
              Fluttertoast.showToast(msg: 'The date has been selected');
            } else {
              setState(() {
                _showError = false;
