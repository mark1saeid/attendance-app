...
class _ActivationState extends State<Activation> {
  ...
  List<Map<String, String>> warning = [
    {'text': 'Face the camera.', 'img': 'assets/face-front.png'},
    {
      'text': 'Turn your face 30 degrees to the right',
      'img': 'assets/face-right.png'
    },
    {
      'text': 'Turn your face 30 degrees to the left',
  ...
  Future onTakeCamera() async {
    ...
    try {
      ...
      Fluttertoast.showToast(msg: 'Failed to take picture!');
      _reload();
      controller?.close();
    }
